...
export default function Home() {
  ...
  // 🔴 union of all blocked ranges => used by Home calendar
  const globalBlocked = useMemo(() => {
    return Object.values(blockedByRoom).flat();
  }, [blockedByRoom]);
  ...
  return (
    <div className="max-w-6xl mx-auto p-4 space-y-6 mb-12">
      ...
      <div className="flex flex-col md:flex-row gap-3 items-start">
        {/* 👉 pass global blocked ranges */}
        <div className="w-full md:w-[50%]">
          <CalendarRange value={range} onChange={setRange} blocked={globalBlocked} />
        </div>
